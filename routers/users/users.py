...
from models.users import webUsers
...
def authenticate_user(username: str, password: str, db: db_dependency):
    user = db.query(webUsers).filter(webUsers.name == username).first()
    if not user:
